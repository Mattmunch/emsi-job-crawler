...
// const getJobInfoTest = async() => {
// //   let jobElements = await getJobInfo(url);
// //   let parsedElements = await Promise.all(jobElements.map(async el => {
// //     let jsonString = (el).jsonValue();
// //     const link = await jsonString;
// //     return link;
// //   }));
// //   console.log(parsedElements);
//   await getJobInfo(url);
// };
// getJobInfoTest();
